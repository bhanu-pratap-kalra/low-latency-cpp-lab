...
int main()
{
	MemoryPool<BigObject> big_object_memory_pool{2};
	BigObject* first_big_object = big_object_memory_pool.acquire(100);
	BigObject* second_big_object = big_object_memory_pool.acquire(200);
	...
	BigObject* third_big_object = big_object_memory_pool.acquire(300);
	...
	BigObject* reused_big_object = big_object_memory_pool.acquire(400);
